# Python 3 - Super simple Elliptic Curve Presentation. No imported libraries, wrappers, nothing.
...
print("The private key (in base 10 format):", privKey, "\n")
print("The uncompressed public key (starts with '04' & is not the public address):", "04", xPublicKey, yPublicKey, "\n")
...
print(f"multiplier 2 = {(r * w) % N}")
print(f"pubkey = ({xPublicKey}, {yPublicKey})")
print(f"Point 1 = ({xu1}, {yu1})")
print(f"Point 2 = ({xu2}, {yu2})")
